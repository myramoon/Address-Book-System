...
public class AddressBook {
    	...
    	/* Creates new contact */
    	public void createContact(AddressBook book1)throws IOException {
	    	Scanner stdin = new Scanner(System.in);
		
		if (book1.numContacts() < 10) {
    			/* Reads in all appropriate information */
			System.out.println("Enter first name:");
    			String firstname = stdin.next();
    		
    			/* Validation code */
    			int check = book1.haveContact(firstname);
    			if(check >= 0) {
    			...
    			book1.addContact(new Contact(firstname,lastname,address,zip,number));
